...
if(EXISTS "${CMAKE_ROOT}/Modules/CPack.cmake")
    ...
    set(project_name "cg2sandbox")   # Name of package project
    set(project_root "cg2sandbox")   # Name of root project that is to be installed

    
    # Package information
    
    string(TOLOWER ${META_PROJECT_NAME} package_name)                       # Package name
    set(package_description     "Computergraphics II Sandbox")                              # Package description
    ...
    set(CMAKE_MODULE_PATH                   ${SANDBOX_SOURCE_DIR}/packages/${project_name})
    ...
    set(CPACK_RESOURCE_FILE_LICENSE         "${SANDBOX_SOURCE_DIR}/LICENSE")
    set(CPACK_RESOURCE_FILE_README          "${SANDBOX_SOURCE_DIR}/README.md")
    set(CPACK_RESOURCE_FILE_WELCOME         "${SANDBOX_SOURCE_DIR}/README.md")
    set(CPACK_PACKAGE_DESCRIPTION_FILE      "${SANDBOX_SOURCE_DIR}/README.md")
